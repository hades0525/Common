...
import com.citycloud.ccuap.intellisense.entity.TFAlarmDataEntity;
...
public class ReflectUtil {
	...
	public static void main(String[] args) throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		...
		dd.put("id", "ads");
		dd.put("eventType", "ads");
		list.add(dd);
		Map<String, Object> alarmInfo = new HashMap<>();
		alarmInfo.put("id", "ads");
		alarmInfo.put("eventType", "ads");
		alarmInfo.put("reportTime", "2019-11-11 12:12:12");
		alarmInfo.put("subType", "ads");
		alarmInfo.put("level", "ads");
		alarmInfo.put("description", "ads");
		alarmInfo.put("cameraCode", "ads");
		alarmInfo.put("organizationCode", "ads");
		alarmInfo.put("districtCode", "ads");
		alarmInfo.put("districtName", "ads");
		alarmInfo.put("streetCode", "ads");
		alarmInfo.put("streetName", "hhhhhhh");
		alarmInfo.put("communityCode", "ads");
		alarmInfo.put("communityName", "ads");
		alarmInfo.put("cellCode", "ads");
		alarmInfo.put("longitude", "ads");
		alarmInfo.put("latitude", "ads");
		alarmInfo.put("address", "ads");
		alarmInfo.put("unitcode", "ads");
		alarmInfo.put("extendvalue", "ads");
		alarmInfo.put("media", list);
		
		TFAlarmDataEntity t = (TFAlarmDataEntity)mapToObj(alarmInfo,TFAlarmDataEntity.class);
